...
jQuery(function(){
	jQuery("div.csw").prepend("<p class='loading'>Loading...<br /><img src='sites/all/themes/shs/images/ajax-loader.gif' alt='loading...'/ ></p>");
});
var j = 0;
jQuery.fn.codaSlider = function(settings) {
	...
	return this.each(function(){
		...
		container.each(function(i) {
			...
			jQuery(this).after("<div class='stripNavR' id='stripNavR" + j + "'><a href='#' id='right-link'>Right</a><\/div>");
